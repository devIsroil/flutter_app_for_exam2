...
class ClappedArticlesPage extends StatefulWidget {
  const ClappedArticlesPage({super.key});

  @override
  State<ClappedArticlesPage> createState() => _ClappedArticlesPageState();
}

class _ClappedArticlesPageState extends State<ClappedArticlesPage> {
